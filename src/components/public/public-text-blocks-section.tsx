...
export function PublicTextBlocksSection({ entryKey, label, title, description, fallback = [], pageKey, }: PublicTextBlocksSectionProps) {
    ...
    return (<section className="space-y-5">
      ...
      <EditableRichText entryKey={entryKey} fallback={richTextFallback} label={label} pageKey={resolvedPageKey} className="rich-text-content rounded-[22px] border border-[#D8E6EB] bg-[#F8FCFD] p-5 text-sm leading-7 text-[#5F7077] shadow-[0_10px_24px_rgba(21,50,59,0.04)] [&_h3]:mt-0 [&_h3]:text-base [&_h3]:font-black [&_h3]:text-[#15323b]"/>
    </section>);
}
