        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-[760px] space-y-2">
            ...
            <p className="text-sm leading-7 text-[#183139] sm:text-[15px]">
              Usamos cookies essenciais para autenticacao, seguranca, manutencao de sessao e funcionamento da plataforma.
              Ao continuar navegando, voce concorda com o uso descrito na nossa politica de cookies.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            <GenflixCtaButton
              ...
              className="pointer-events-auto h-11 px-5 text-[13px] font-bold uppercase tracking-[0.12em]"
            >
              <Link to="/cookies?preferences=1">Preferencias</Link>
            </GenflixCtaButton>

            <button
              type="button"
              onClick={() => setState(createCookieConsentState({
                analytics: true,
