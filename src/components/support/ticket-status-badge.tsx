...
export function TicketStatusBadge({ status }: {
    ...
    return (<span className={`inline-flex items-center rounded-full border px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] ${getSupportStatusBadgeClass(status)}`}>
