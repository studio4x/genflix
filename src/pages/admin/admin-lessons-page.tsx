          ...
          <div className={`p-5 min-h-[64px] flex items-center border-b ${isEditing ? 'bg-amber-50/50 border-amber-100' : 'bg-slate-50 border-slate-100'}`}>
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              {isEditing ? (<>
                  ...
                  <svg className="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>N?ova Aula
                </>)}
            </h3>
          </div>
