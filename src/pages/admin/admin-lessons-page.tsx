            ...
            {lessons.map((lesson, index) => (
              <article
                ...
                className={`flex flex-col overflow-hidden rounded-2xl border bg-white shadow-sm transition-all ${
                  editingLessonId === lesson.id ? 'border-amber-300 ring-1 ring-amber-300' : 'border-slate-200 hover:border-slate-300'
                }`}
              >
                <div className="p-4 sm:p-5 flex gap-4">
                  ...
                  <div className="flex-1 space-y-2 py-1">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          {lesson.is_required ? (
                            <span className="inline-flex px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-700 border border-blue-200">Obrigatória</span>
                          ) : (
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-slate-500">
                      ...
                      {lesson.youtube_url ? (
                        <a href={lesson.youtube_url} target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-blue-600 hover:text-blue-800 font-medium hover:underline">
                    ...
                    {lesson.description && (
                      <p className="text-sm text-slate-500 line-clamp-2 leading-relaxed mt-2 p-3 bg-slate-50 rounded-lg">{lesson.description}</p>
                    )}
                  </div>
                </div>
