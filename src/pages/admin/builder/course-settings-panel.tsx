         ...
         <div className="bg-white rounded-[32px] border border-slate-200 shadow-sm p-6 md:p-10 space-y-10">
            ...
            <section className="rounded-[32px] border border-slate-200 bg-slate-50/40 p-5 md:p-6">
               ...
               <div className="mt-6 grid gap-4 xl:grid-cols-[260px_minmax(0,1fr)]">
                  <div className="relative overflow-hidden rounded-[28px] border border-[#0B5D8D]/20 bg-[radial-gradient(circle_at_top,_rgba(36,188,224,0.24),_transparent_55%),linear-gradient(145deg,#1AA0C7_0%,#104E6B_100%)] shadow-[0_24px_44px_rgba(16,78,107,0.18)] min-h-[194px]">
                     {form.thumbnail_url ? (
                        <>
                        ...
                        <span className="text-sm font-medium text-slate-500">
                           {isUploadingThumbnail
                             ...
                             : form.thumbnail_url
                               ...
                               : 'Selecione um arquivo para definir a capa do curso.'}
                        </span>
                     </div>
                     ...
                     {form.thumbnail_url ? (
                        <div className="mt-5 flex flex-wrap items-center gap-3">
                           ...
                           <Button
                              ...
                              className="h-7 gap-1 rounded-xl border-slate-200 bg-white px-2.5 text-[0.8rem] font-bold text-slate-600 hover:text-slate-900"
                           >
                              Remover imagem
                           </Button>
                        </div>
