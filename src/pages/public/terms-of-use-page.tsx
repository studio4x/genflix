...
export function TermsOfUsePage() {
    ...
    return (<PublicLegalPageShell documentKey="terms" eyebrow={document.eyebrow} title={document.title} summary={document.summary} updatedAt={document.updatedAt} currentPage="terms">
      {document.content}
