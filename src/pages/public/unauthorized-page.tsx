...
export function UnauthorizedPage() {
    return (<GenflixAuthLayout entryPrefix="global.auth.unauthorized" title="Acesso restrito" subtitle="Esta área do GenFlix exige permissão específica para continuar." imageUrl={genflixHeroImage}>
      <div className="rounded-[24px] border border-[#D8E6EB] bg-[#F2F7F9] p-6 text-[#163138] shadow-[0_18px_36px_rgba(22,49,56,0.06)]">
        ...
        <h2 className="mt-5 font-readex text-[1.7rem] font-medium text-[#163138]">Você não tem acesso a est página
        </h2>
