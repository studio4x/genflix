...
export function PublicFaqPage() {
    return (<PublicGenericPage entryPrefix="global.institutional.faq" eyebrow="Ajuda rápida" title="Perguntas frequentes" description="Reunimos aqui os principais tópicos que serão expandidos conforme a central de ajuda pública da GenFlix evoluir." backgroundClassName="bg-white" sections={[
            {
                ...
                paragraphs: [
                    ...
                    "Nest primeira entrega, a p\u00E1gina entra como placeholder institucional para garantir navega\u00E7\u00E3o consistente a partir do novo rodap\u00E9 global.",
                ],
            },
            {
