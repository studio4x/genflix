            ...
            <aside className="lg:sticky lg:top-24">
              <div className="overflow-hidden rounded-[26px] border border-[#D8E6EB] bg-white shadow-[0_24px_60px_rgba(21,50,59,0.08)]">
                <div className="space-y-6 p-6">
                  ...
                  {playerEntryHref ? (
                    <GenflixCtaButton asChild tone="surface" className="w-full border-[#1d728f] bg-[#f78902] px-5 py-3 text-white shadow-[0_5px_0_#1151B1,0_10px_18px_rgba(17,81,177,0.2)] hover:border-[#1d728f] hover:bg-[#f78902] hover:shadow-[0_6px_0_#1151B1,0_12px_22px_rgba(17,81,177,0.24)] [&>span:last-child]:bg-white [&>span:last-child]:text-[#1151B1]">
                      <Link to={playerEntryHref}>Assista a uma aula gratuita</Link>
                    </GenflixCtaButton>
                  ) : (
                    <GenflixCtaButton tone="surface" className="w-full border-[#1d728f] bg-[#f78902] px-5 py-3 text-white shadow-[0_5px_0_#1151B1,0_10px_18px_rgba(17,81,177,0.2)] hover:border-[#1d728f] hover:bg-[#f78902] hover:shadow-[0_6px_0_#1151B1,0_12px_22px_rgba(17,81,177,0.24)] [&>span:last-child]:bg-white [&>span:last-child]:text-[#1151B1]" disabled>
