...
const cookieTopics = [
  'A GenFlix pode utilizar cookies e tecnologias semelhantes estritamente necessárias para autenticação, segurança da sessão, navegação e funcionamento técnico do LMS.',
...
export function CookiesPage() {
  return (
    <PublicLegalPageShell
      ...
      summary="Esta página explica, de forma objetiva, como o ambiente GenFlix pode usar cookies e tecnologias semelhantes para autenticação, segurança e funcionamento do serviço."
