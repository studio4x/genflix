      ...
      <header className="flex flex-col gap-5 border-b border-slate-100 pb-8 xl:flex-row xl:items-start xl:justify-between">
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl font-black tracking-tight text-slate-900 sm:text-5xl">Olá, {firstName}!</h1>
        ...
        <div className="space-y-6">
          ...
          <article className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-3">
              ...
              <Link to="/aluno/notificacoes" className="flex items-center justify-between rounded-[24px] border border-slate-200 bg-slate-50 px-5 py-4 transition-all hover:border-slate-300 hover:bg-slate-100/70">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-base font-black text-slate-900">Abrir notificações</p>
                    <p className="text-sm font-medium text-slate-500">Veja avisos e preferências em uma página própria.</p>
                  </div>
                </div>
              ...
              <Link to="/aluno/preferencias-notificacoes" className="flex items-center justify-between rounded-[24px] border border-slate-200 bg-white px-5 py-4 transition-all hover:border-slate-300 hover:bg-slate-50">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-base font-black text-slate-900">Preferências de notificação</p>
                    <p className="text-sm font-medium text-slate-500">Defina canais, frequência e horário de silêncio.</p>
                  </div>
                </div>
                <svg className="h-5 w-5 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          {featuredCourse ? (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-base font-black text-slate-900">Continuar agora</p>
                  <p className="text-sm font-medium text-slate-500">{featuredCourse.title}</p>
                </div>
              </div>
              <span className="text-xs font-black uppercase tracking-[0.18em] text-slate-500">{featuredCourseLabel}</span>
            </Link>
          ) : null}
        </div>
        ...
        <article className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5">
            {recommendedCourses.length > 0 ? (
              ...
              <div className="rounded-[28px] border border-dashed border-slate-200 bg-slate-50 p-8 text-center text-sm font-medium text-slate-500">
