  ...
  return (
    <div className="space-y-12 pb-24 animate-in fade-in duration-700">
      ...
      <section className="bg-white rounded-[32px] border border-slate-100 p-6 shadow-sm animate-in slide-in-from-top-4 duration-700 delay-300">
         ...
         <div className="flex w-full min-w-0 flex-col justify-center gap-1 rounded-2xl border border-slate-100 bg-slate-50/60 px-4 py-3 lg:w-[220px] lg:shrink-0 lg:self-start">
