                ...
                {m.lessons.map((l) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group flex items-start gap-3 rounded-lg p-2.5 text-sm transition-all ${
                        isBlocked ? 'cursor-not-allowed grayscale opacity-50' : 'cursor-pointer hover:bg-slate-100/80'
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4 sm:px-6">
          <div className="flex items-center gap-4">
            <button
              ...
              className="rounded-lg p-2 -ml-2 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600"
            >
