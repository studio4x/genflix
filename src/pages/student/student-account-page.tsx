        ...
        <div className="space-y-6">
          ...
          <article className="rounded-[32px] border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 p-6 text-white shadow-sm">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/aluno/dashboard" className="inline-flex h-11 items-center justify-center rounded-2xl bg-white px-4 text-sm font-black text-blue-700 transition-colors hover:bg-slate-100 hover:text-blue-800">
                Ir para dashboard
              </Link>
