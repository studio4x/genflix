...
import { fetchCreatorPayoutProfile, upsertCreatorPayoutProfile, type PixKeyType, } from '@/features/creator/profile/api';
        ...
        <div className="space-y-5">
          <article className="rounded-[28px] border border-[#D8E6EB] bg-[#F2F7F9] p-5">
            ...
            <div className="mt-5 flex flex-col gap-5 sm:flex-row sm:items-start">
              {profile?.avatar_url ? (<img src={profile.avatar_url} alt="Avatar atual do criador" className="h-24 w-24 rounded-[28px] border border-[#D8E6EB] object-cover shadow-sm"/>) : (<div className="flex h-24 w-24 items-center justify-center rounded-[28px] bg-gradient-to-br from-[#1398B7] to-[#0A3640] text-xl font-black text-white shadow-sm">
