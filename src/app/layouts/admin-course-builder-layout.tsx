          ...
          <aside className={`shrink-0 flex flex-col bg-white border-r border-slate-200 transition-all duration-300 ${isSidebarOpen ? 'w-80 lg:w-96' : 'w-0 overflow-hidden'}`}>
            ...
            <div className="p-3 border-t border-slate-100">
               <div className="space-y-1">
                  ...
                  <Link to={`/admin/cursos/${courseId}/liberacoes`} className="group flex items-center gap-2.5 p-2.5 rounded-lg text-sm transition-colors text-slate-600 hover:bg-slate-100">
