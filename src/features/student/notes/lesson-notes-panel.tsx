      ...
      <div className="border-b border-slate-100 px-6 py-5 sm:px-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <Button
            ...
            className={isOpen ? 'rounded-xl border-slate-200 bg-white font-bold text-slate-700' : 'rounded-xl bg-slate-900 font-bold text-white hover:bg-slate-800'}
          >
          ...
          {isLoading ? (
            ...
            <>
              <textarea
                ...
                placeholder="Escreva aqui suas anotacoes desta aula. O texto sera salvo automaticamente."
                className="min-h-[240px] w-full rounded-[28px] border border-slate-200 bg-slate-50/50 px-5 py-4 text-sm font-medium leading-7 text-slate-700 shadow-inner focus:border-blue-300 focus:outline-none focus:ring-4 focus:ring-blue-100"
              />
