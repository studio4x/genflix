...
export const COURSE_QUIZ_TYPE_OPTIONS: CourseQuizTypeOption[] = [
    ...
    },
    {
        ...
        helper: "Disponivel apenas como pergunta independente nest? vers?o.",
    ...
    },
    {
        ...
        helper: "Depende de Multipla Escolha ou Discursiva com IA est?rem ativas.",
        accentClassName: 'border-violet-200 bg-violet-50/60 text-violet-700',
        badgeClassName: 'bg-violet-600 text-white',
    },
];
export function normalizeCourseQuizTypeSettings(value: Partial<CourseQuizTypeSettings> | null | undefined): CourseQuizTypeSettings {
    return {
...
export function getVisibleCourseQuizTypeOptions(globalSettings: Partial<CourseQuizTypeSettings> | null | undefined) {
...
export function getEffectiveCourseQuizTypeSettings(settings: Partial<CourseQuizTypeSettings> | null | undefined, globalSettings?: Partial<CourseQuizTypeSettings> | null | undefined): CourseQuizTypeSettings {
...
export function isCourseQuizSettingEnabled(settings: Partial<CourseQuizTypeSettings> | null | undefined, key: CourseQuizTypeSettingKey, globalSettings?: Partial<CourseQuizTypeSettings> | null | undefined) {
    return getEffectiveCourseQuizTypeSettings(settings, globalSettings)[key];
}
export function isCourseQuestionTypeEnabled(settings: Partial<CourseQuizTypeSettings> | null | undefined, questionType: AssessmentQuestionType, globalSettings?: Partial<CourseQuizTypeSettings> | null | undefined) {
...
export function canCourseUseCaseStudies(settings: Partial<CourseQuizTypeSettings> | null | undefined, globalSettings?: Partial<CourseQuizTypeSettings> | null | undefined) {
    const normalizedSettings = getEffectiveCourseQuizTypeSettings(settings, globalSettings);
    return normalizedSettings.case_study && (normalizedSettings.single_choice || normalizedSettings.essay_ai);
}
export function hasAnyCourseQuizTypeEnabled(settings: Partial<CourseQuizTypeSettings> | null | undefined, globalSettings?: Partial<CourseQuizTypeSettings> | null | undefined) {
    const normalizedSettings = getEffectiveCourseQuizTypeSettings(settings, globalSettings);
