...
export function normalizeSiteAppearance(value: unknown, fallback: SiteAppearanceFields = defaultSiteAppearance, defaultScope: SiteAppearanceScopeMode = 'page'): NormalizedSiteAppearance {
    const source = isStringRecord(value) ? value : {};
...
export function resolveSiteAppearanceVariant(value: NormalizedSiteAppearance, viewport: SiteAppearanceViewport): SiteAppearanceFields {
