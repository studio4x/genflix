...
export function BannerPlacementSlot({ pageKey, placementKey, fallback = null, }: BannerPlacementSlotProps) {
    ...
    return (<>
      {locationKeys.map((locationKey) => (<HomeBannerCarousel key={locationKey} locationKey={locationKey as SiteBannerLocationKey} fallback={fallback}/>))}
    </>);
}
