...
export type AssessmentQuestionType = 'single_choice' | 'essay_ai' | 'case_study_ai' | 'case_study_single_choice' | 'drag_drop_labeling' | 'fill_in_the_blanks' | 'image_hotspot' | 'coloring';
...
export type ColoringInteractionContent = LegacyColoringInteractionContent | SvgColoringInteractionContent;
export type AssessmentInteractionContent = DragDropLabelingInteractionContent | FillInTheBlanksInteractionContent | ImageHotspotInteractionContent | ColoringInteractionContent;
...
export type AssessmentQuestionAnswerKeyPayload = TokenMappingAnswerKeyPayload | ImageHotspotAnswerKeyPayload;
...
export type AssessmentInteractionResponsePayload = TokenMappingResponsePayload | ImageHotspotResponsePayload;
