# Sprint 0 - Checklist de Conclusao (Obrigatorios)

1. Projeto separado criado em pasta propria.
2. Stack base configurada: React 18, TypeScript, Vite.
3. Tailwind CSS e shadcn/ui inicializados.
