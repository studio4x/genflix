...
async function resolveMaterial(supabaseAdmin: ReturnType<typeof createClient>, requestBody: Record<string, unknown>) {
    ...
    if (!materialId && !storagePath) {
        throw new Error("material_id ou storage_path obrigatrio.");
    }
