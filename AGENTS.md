...
3. Vercel: antes de encerrar qualquer `commit`/`push`, verificar que `genflix-omega.vercel.app` aponta para o ultimo deploy `READY` cuja revisao corresponde ao `HEAD` atual.
